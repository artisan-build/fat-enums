...
final class AsNullableEnumCollectionBitmaskTest extends TestCase
{
    #[Test]
    ...
    {
        /** @var Model&{permissions: Collection<PermissionEnum>|null} */
        $model = new class extends Model
        {
            protected function casts(): array
            {
    ...
    public function it_throws_exception_for_invalid_enum_class()
    {
        ...
        $model = new class extends Model
        {
            ...
            {
                return [
                    'permissions' => AsNullableEnumCollectionBitmask::of('InvalidEnum'),
                ];
            }
        };
